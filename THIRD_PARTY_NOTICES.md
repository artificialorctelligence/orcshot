...
- **Location in this repo:** `src/orcshot/resources/gnome-shell-extensions/orcshot@orcshot.org/windows.js` (a module of the merged `orcshot@orcshot.org` extension since 2026-09-11; it was its own `window-calls@domandoman.xyz` directory before)
- **Upstream:** https://github.com/ickyicky/window-calls
- **License:** GPL-2.0-or-later (SPDX header in `windows.js`; compatible with this
...
- **Modifications from upstream:** three bug fixes and one small addition, documented
  in full in a comment block at the top of `windows.js` itself (a

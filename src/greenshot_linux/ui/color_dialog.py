...
from greenshot_linux.core.color_palette import add_recent_color, color_palette_grid
from greenshot_linux.settings import get_recent_colors, set_recent_colors
from greenshot_linux.ui.eyedropper import start_eyedropper

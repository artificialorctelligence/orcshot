...
def start_eyedropper(
    ...
    if os.environ.get("XDG_SESSION_TYPE") == "wayland":
        ...
        from orcshot.capture.gnome_eyedropper import is_available as gnome_shell_capture_available
        ...
        if gnome_shell_capture_available():
            ...
            # nested main loop.
            from orcshot.capture.gnome_eyedropper import start_eyedropper as start_gnome_shell_eyedropper
